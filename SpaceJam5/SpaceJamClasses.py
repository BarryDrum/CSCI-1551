...
class Universe(InverseSphereCollideObject):
    def __init__(self, loader: Loader, modelPath: str, parentNode: NodePath, nodeName: str, texPath: str, scaleVal: float):
        super(Universe, self).__init__(loader, modelPath, parentNode, nodeName, Vec3(0, 0, 0), scaleVal * 0.9)
...
class SpaceShip(SphereCollideObj):
    ...
    def Fire(self):
        if self.missileBay:
            ...
            aim = render.getRelativeVector(self.model, Vec3(0, 1, 0))
            aim.normalize()
            ...
            print("Reloading...")
            taskMgr.add(self.Reload, 'reloadTask')
...
class Missile(SphereCollideObj):
    ...
    def __init__(self, loader: Loader, modelPath: str, parentNode: NodePath, nodeName: str, posVec: Vec3, radius: float = 1.0):
