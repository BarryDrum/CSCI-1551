...
class Wanderer(SphereCollideObj):
    ...
    def __init__(self, loader: Loader, modelPath: str, parentNode: NodePath, modelName: str, scaleVec: Vec3, texPath: str, staringAt: Vec3):
        ...
        offset = Wanderer.numWanderers * 1000

        posInterval0 = self.modelNode.posInterval(20, Vec3(300 + offset, 6000, 500), startPos = Vec3(offset, 0, 0))
        posInterval1 = self.modelNode.posInterval(20, Vec3(700 + offset, -2000, 100), startPos = Vec3(300 + offset, 6000, 500))
        posInterval2 = self.modelNode.posInterval(20, Vec3(0 + offset, -900, -1400), startPos = Vec3(700 + offset, -2000, 100))
        posInterval3 = self.modelNode.posInterval(20, Vec3(0 + offset, 0, 0), startPos = Vec3(0 + offset, -900, -1400))

        self.travelRoute = Sequence(posInterval0, posInterval1, posInterval2, posInterval3, name =f"Traveler-{Wanderer.numWanderers}")
