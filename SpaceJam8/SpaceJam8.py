...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.pusher.addCollider(self.SpaceShip.collisionNode, self.SpaceShip.model)
    ...
    def SetupScene(self):
        ...
        self.lavaPlanet = spaceJamClasses.Planet(self.loader, "./Assets/Universe/protoPlanet.x", self.render, "Lava", "./Assets/Planets/Lava.jpg", (3000, 14500, 3000), 600)
        ...
        self.SpaceShip = spaceJamClasses.SpaceShip(self.loader, "./Assets/SpaceShips/Dumbledore/Dumbledore/Dumbledore.x", self.render, "SpaceShip", "./Assets/SpaceShips/Dumbledore/Dumbledore/spacejet_N.png", (0, 400, -70), 30, (0, 0, 0), self.cTrav)
        self.Sentinal1 = spaceJamClasses.Orbiter(self.loader, self.taskMgr, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.neptunePlanet, 900, "MLB", self.SpaceShip)
        self.Sentinal1 = spaceJamClasses.Orbiter(self.loader, self.taskMgr, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.jupiterPlanet, 900, "MLB", self.SpaceShip)
        self.Sentinal2 = spaceJamClasses.Orbiter(self.loader, self.taskMgr, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.marsPlanet, 900, "Cloud", self.SpaceShip)        
        self.Sentinal2 = spaceJamClasses.Orbiter(self.loader, self.taskMgr, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.sherbertPlanet, 900, "Cloud", self.SpaceShip)
        self.Wanderer1 = spaceJamClasses.Wanderer(self.loader, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.SpaceShip)
        self.Wanderer2 = spaceJamClasses.Wanderer(self.loader, "./Assets/DroneDefender/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, "./Assets/DroneDefender/DroneDefender/octotoad1_auv.png", self.SpaceShip)
        ...
        for j in range(fullCycle):
            ...
            lavaName = f"lavaDrone{spaceJamClasses.Drone.droneCount}"
            ...
            self.DrawBaseballSeams(self.lavaPlanet, lavaName, j, fullCycle, 2)
    ...
    def DrawBaseballSeams(self, centralObject, droneName, step, numSeams, radius = 1):
        ...
        unitVec.normalize()
        position = unitVec * radius * 700 + centralObject.model.getPos()
    ...
    def ToggleCamera(self):
        ...
        if self.thirdPerson:
            self.camera.reparentTo(self.SpaceShip.model)
            self.camera.setPos(0, -10, 50)
            self.camera.lookAt(self.SpaceShip.model)
